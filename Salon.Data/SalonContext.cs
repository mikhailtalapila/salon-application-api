...
namespace Salon.Data
{
    public class SalonContext: DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=.\SQLEXPRESS;Database=Salon;User Id=sa;password=Nails2016!!!;MultipleActiveResultSets=true");
        }
        ...
        public virtual DbSet<EmployeeStandardShift> EmployeeStandardShifts { get; set; }
